...
@interface WXMAVAssetExportSession ()
...
@implementation WXMAVAssetExportSession
{
    NSError *_error;
...
//{
//    return [WXMAVAssetExportSession.alloc initWithAsset:asset];
//}
...
- (AVMutableVideoComposition *)buildDefaultVideoComposition
{
	...
	// Workaround radar 31928389, see https://github.com/rs/WXMAVAssetExportSession/pull/70 for more info
	if (transform.ty == -560) {
		transform.ty = 0;
	}
