//
//  WXMAVAssetExportSession.h
//
// This file is part of the WXMAVAssetExportSession package.
//
...
@protocol WXMAVAssetExportSessionDelegate;


/**
 * An `WXMAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@interface WXMAVAssetExportSession : NSObject

@property (nonatomic, weak) id<WXMAVAssetExportSessionDelegate> delegate;
...
@protocol WXMAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(WXMAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
